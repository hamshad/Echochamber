...
- **URL detection and YouTube playback** — added redirect and play buttons for URLs in shared text items, positioned alongside action buttons in item headers; fixed YouTube popup to show visible video
